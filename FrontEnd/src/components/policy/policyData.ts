const data = {
  privacy: `# 개인정보 취급 방침
## 1. 개인정보의 수집 및 이용 목적
WEMET(이하 "회사")는 수집한 개인정보를 다음의 목적을 위해 활용합니다. 
- 회원 관리
- 서비스 제공
## 2. 개인정보의 보유 및 이용기간
...
이 개인정보 취급방침은 20XX년 XX월 XX일부터 적용됩니다.`,
  terms: `# 서비스 이용약관
## 제 1조 목적
본 약관은 회원(본 약관에 동의한 자를 말하며 이하 "회원"이라고 합니다)이 WEMET(이하 "회사"라고 합니다)가 제공하는 서비스를 이용함에 있어 회사와 회원의 권리 의무 및 책임사항을 규정함을 목적으로 합니다.
## 제 2조 정의
